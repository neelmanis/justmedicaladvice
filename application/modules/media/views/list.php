				...
				<div class="container-fluid maxwidth">
					<div class="container-fluid" data-sticky_parent>
						<div class="col-md-9 breadcrum">
							<div class="row">
							<div class="col-sm-8"><div class="row">Media</div></div>
						...
						<div class="col-md-9 content_panel">
							<div id="result"></div>
							<button class="btn bluebtn" id="load_more" data-val = "1" style="margin:0 auto 20px;display:table;width:100%; max-width:280px;">View More Media</button>
						</div>    	
