<div class="row mt">
    <div class="col-lg-12">
        <div class="content-panel">
			...
			<div class="col-lg-4"></div>
			<div class="col-lg-4">
				<a href="<?php echo base_url('speciality/add-speciality');?>"><button class="btn btn-success btn-lg btn-block">Add Speciality</button></a>
			</div>
					...
					<?php 
						if(is_array($specialities) && !empty($specialities)){
							...
							foreach($specialities as $sp){
								...
								$url = base_url();
								if($sp['isActive'] == 0){
									$msg = '<a class="label label-danger label-mini" href="'.$url.'speciality/activeAction/'.$id .'" onclick="return(window.confirm(\'Are you sure you want to Active?\'));">Inactive</a>';           
								}else{
									$msg = '<a class="label label-success label-mini" href="'.$url.'speciality/inActiveAction/'.$id.'" onclick="return(window.confirm(\'Are you sure you want to Deactive?\'));">Active</a>';  
								}	 	
					?> 
						<tr>
							...
							<td data-title="Actions">
								...
								<a class="btn btn-primary btn-xs" href='<?php echo base_url();?>speciality/edit-speciality/<?php echo $id;?>' title='Edit Category'><i class="fa fa-pencil"></i></a>
							</td>
						</tr>
					<?php
						$i++; } } 
